...
Implementation of FCD-Couplings from Voityuk J. Phys. Chem. 2002 and Hsu J. Phys. Chem. C (2008)
...
dmxs2 = FED.xs2xs_denisty_matrix_dom(tdhf, 2, 2)

dip_xs2xs = FED.dip_moment_dom(mol, dmxs2xs)
mf.dip_moment(mol, dmxs2xs, unit='A.U.')

FED.mulliken_pop_dom_transition(mol, dmxs2xs, s)
FED.mulliken_pop_dom(mol, dmxs2, s)
